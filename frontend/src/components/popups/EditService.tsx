import {
  ...
  function EditService({
    ...
    useEffect(() => {
      ...
      setSubmitLoading("Loading Service...");
        (async () => {
            const data = await axios.get(`${getBaseURL()}/service/${popUpTarget}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                },
            })
            ...
            setServiceName(data.data.service.title);
            setServiceSubtitle(data.data.service.subtitle);
            setServiceIconSelected(data.data.service.icon);
            setServiceIconMode("select");
            setServiceLink(data.data.service.link);
    ...
    const submit = () => {
      ...
      (async () => {
        ...
        axios
          .patch(`${getBaseURL()}/service/${popUpTarget}`, data, {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          })
